...
1. Lecture 1: `Introduction`
   Slides exist in the calendar, but there is no Marimo notebook for this lecture.
2. Lecture 13: `TBD`
...
1. Decide whether Lecture 1 should stay slide-only or get a short Marimo notebook.
2. Decide whether to add a project starter notebook, for example `assignments/final.py` or similar.
